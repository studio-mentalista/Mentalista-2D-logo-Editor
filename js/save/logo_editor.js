//GLOBAL VAR
			...
			var height_gap = 60;
			var rect_size = 10;
			var w_margin = (window.innerWidth-width_gap*4)/2;
			var h_margin = (window.innerHeight-height_gap*4)/2-50;
			var circle = false;
			var grid_color = '#000000'; //dat.GUI color scheme selection 
										//https://bl.ocks.org/mootari/bfbf01320da6c14f9cba186c581d507d
			
			var bezier;
			var smooth = 0;
			var strokeWidth = 3;
			var bezier_debug = false;
			...
			function randomize(){
				...
				var bezier_count = Math.floor(Math.random() * (30 - 1 + 1)) + 1;
